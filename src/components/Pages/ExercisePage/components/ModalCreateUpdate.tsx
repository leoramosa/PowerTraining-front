...
const ModalCreatUpdate: React.FC<IModalData>  = ({isSubmitting, typeModal, nameModal, dataExercise, handleSubmit, handleChange, handleBlur, validateDisabledSubmitButton, closeModal, errors}) => {

    return (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
          <h2 className="text-xl font-bold mb-4">{nameModal}</h2>
