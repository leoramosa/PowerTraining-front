...
const ButtonNoOk: React.FC<ButtonPrimaryProps> = ({ text, onClick, type, disabled, icon }) => {
  const styleEnabled = "bg-red-600 hover:bg-red-700 text-white py-2 px-5 mx-3 rounded-lg shadow-sm hover:shadow-sm transition duration-300 ease-in-out transform hover:-translate-y-1";
