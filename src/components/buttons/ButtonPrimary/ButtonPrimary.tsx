...
const ButtonPrimary: React.FC<ButtonPrimaryProps> = ({ text, onClick, type, disabled }) => {
  const styleEnabled = "bg-primary hover:bg-primarLight text-white py-2 px-5 mx-3 rounded-lg shadow-sm hover:shadow-sm transition duration-300 ease-in-out transform hover:-translate-y-1";
